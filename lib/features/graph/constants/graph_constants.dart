...
class GraphConstants {
  ...
  static const Duration physicsFrameDuration = Duration(milliseconds: 16); // ~60 FPS
  ...
  static double calculateNodeRadius(int connectionCount) {
    final calculatedRadius = baseNodeRadius + (connectionCount * radiusPerConnection);
  ...
  static double calculateFontSize(double radius) {
    return radius > connectionThresholdForLargeFont ? largeFontSize : smallFontSize;
  }
  
  /// Calculate font weight based on node radius
  static FontWeight calculateFontWeight(double radius) {
    return radius > connectionThresholdForLargeFont ? boldFontWeight : normalFontWeight;
  }
